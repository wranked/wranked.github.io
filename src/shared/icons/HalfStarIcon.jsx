...
export default function HalfStarIcon({
  ...
  return (
    <>
      ...
      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" className="one,star" color="#ffc107" size={size} height={size} width={size} xmlns="http://www.w3.org/2000/svg" style={{ color: bgColor }}>
